...
export const LANGUAGES = [
  ...
  { code: 'zh-CN', name: 'Chinese (Simplified)',    nativeName: '中文简体',          readingDirection: 'ltr', style: 'manhua' },
  { code: 'zh-TW', name: 'Chinese (Traditional)',   nativeName: '中文繁體',          readingDirection: 'ltr', style: 'manhua' },
